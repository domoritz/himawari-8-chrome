...
* Switch between visible light and infrared images from [Himawari 8](http://himawari8.nict.go.jp/), images from the EPIC camera on the [DSCOVR](http://www.nesdis.noaa.gov/DSCOVR/) satellite, and [GOES 13](https://en.wikipedia.org/wiki/GOES_13) or [GOES 15](https://en.wikipedia.org/wiki/GOES_15) (can only switch in the extension).
